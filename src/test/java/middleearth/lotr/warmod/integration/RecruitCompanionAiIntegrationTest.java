...
public final class RecruitCompanionAiIntegrationTest {
    ...
    private static void recruitUsesSinglePlannerRuntimeController() throws IOException {
        ...
        assertTrue(count(entity,
                        "!MiddleEarthRecruitEntity.this.hasAuthoritativeArmyGroup() && super.canUse()") >= 2,
    ...
    private static void controllerIntegratesExistingPlannerPipeline() throws IOException {
        String controller = read("src/main/java/middleearth/lotr/warmod/army/ArmyRecruitRuntimeController.java");
    ...
    private static void explicitAttackTargetsAreGuarded() throws IOException {
        ...
        String policy = read("src/main/java/middleearth/lotr/warmod/army/ArmyAttackTargetPolicy.java");
    ...
    private static void workerRuntimeConsumesSavedDataAuthority() throws IOException {
        String entity = read("src/main/java/middleearth/lotr/warmod/entity/MiddleEarthRecruitEntity.java");
        String savedData = read("src/main/java/middleearth/lotr/warmod/kingdom/KingdomSavedData.java");
