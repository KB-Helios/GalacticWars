...
public final class BlueprintAuthorityTest {
    ...
    private static void canonicalIdsRetainLegacyAliases() {
        KingdomBaseBlueprint legacy = blueprint("house", BlueprintAnchor.ORIGIN, List.of(0));
        assertEquals("kingdomwarsmiddleearth:house", legacy.id(), "canonical legacy id");
        assertEquals(KingdomBaseBlueprint.byId("house").orElseThrow().id(),
                KingdomBaseBlueprint.byId("kingdomwarsmiddleearth:house").orElseThrow().id(),
