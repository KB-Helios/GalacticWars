...
public final class WorkerWorksiteIntegrationTest {
    ...
    private static void recruitPersistsWorksiteAndUsesWorkCommand() throws IOException {
        ...
        String actions = read("src/main/java/galacticwars/clonewars/recruitment/RecruitmentAction.java");
    ...
    private static void screenRendersWorksiteButtons() throws IOException {
        ...
        assertContains(screen, "screen.galacticwars.recruit.worksite.set", "set worksite screen label");
        assertContains(screen, "screen.galacticwars.recruit.worksite.return", "return worksite screen label");
        assertContains(screen, "screen.galacticwars.recruit.worksite.clear", "clear worksite screen label");
        assertContains(screen, "screen.galacticwars.recruit.worksite.radius.decrease", "decrease radius screen label");
        assertContains(screen, "screen.galacticwars.recruit.worksite.radius.increase", "increase radius screen label");
    }
    ...
    private static void languageContainsWorksiteMessages() throws IOException {
        ...
        assertContains(language, "\"screen.galacticwars.recruit.worksite.set\"", "set label translation");
        assertContains(language, "\"screen.galacticwars.recruit.worksite.return\"", "return label translation");
        assertContains(language, "\"screen.galacticwars.recruit.worksite.clear\"", "clear label translation");
        assertContains(language, "\"screen.galacticwars.recruit.worksite.radius.decrease\"", "decrease radius label translation");
        assertContains(language, "\"screen.galacticwars.recruit.worksite.radius.increase\"", "increase radius label translation");
        assertContains(language, "\"screen.galacticwars.recruit.status.work_radius\"", "work radius status translation");
        assertContains(language, "\"message.galacticwars.recruit.worksite.set\"", "set message translation");
        assertContains(language, "\"message.galacticwars.recruit.worksite.return\"", "return message translation");
        assertContains(language, "\"message.galacticwars.recruit.worksite.missing\"", "missing message translation");
        assertContains(language, "\"message.galacticwars.recruit.worksite.clear\"", "clear message translation");
        assertContains(language, "\"message.galacticwars.recruit.worksite.radius\"", "radius message translation");
    }
